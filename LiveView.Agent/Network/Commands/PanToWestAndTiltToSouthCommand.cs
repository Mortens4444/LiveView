...
{
    public class PanToWestAndTiltToSouthCommand : ICommand
    {
        private readonly Dictionary<string, VideoCapture> videoCaptures;
        private readonly string videoCaptureId;
        private readonly double value;

        public PanToWestAndTiltToSouthCommand(Dictionary<string, VideoCapture> videoCaptures, string videoCaptureId, string value)
        {
