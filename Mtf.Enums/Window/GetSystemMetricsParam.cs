namespace Mtf.Enums.Window
{
    public enum GetSystemMetricsParam : int
    {
        ...
        /// <summary>The value that specifies how the system is started:</summary>
        SM_CLEANBOOT = 67,
        ...
        /// <summary>The same as SM_CXFIXEDFRAME.</summary>
        SM_CXDLGFRAME = 7,

        /// <summary>The width of the rectangle around the location of a first click in a double-click sequence, in pixels. The second click must occur within the rectangle that is defined by SM_CXDOUBLECLK and SM_CYDOUBLECLK for the system to consider the two clicks a double-click. The two clicks must also occur within a specified time.  To set the width of the double-click rectangle, call SystemParametersInfo with SPI_SETDOUBLECLKWIDTH.</summary>
        SM_CXDOUBLECLK = 36,

        /// <summary>The width of a rectangle that is centered on a drag point to allow for limited movement of the mouse pointer before a drag operation begins, in pixels. It allows the user to click and release the mouse button easily without unintentionally starting a drag operation.</summary>
        SM_CXDRAG = 68,

        /// <summary>The width of a 3-D border, in pixels. This is the 3-D counterpart of SM_CXBORDER.</summary>
        SM_CXEDGE = 45,

        /// <summary>The thickness of the frame around the perimeter of a window that has a caption but is not sizable, in pixels. SM_CXFIXEDFRAME is the height of the horizontal border, and SM_CYFIXEDFRAME is the width of the vertical border. The same as SM_CXDLGFRAME.</summary>
        SM_CXFIXEDFRAME = 7,

        /// <summary>The width of the left and right edges of the focus rectangle that the DrawFocusRect draws. This value is in pixels.</summary>
        SM_CXFOCUSBORDER = 83,

        /// <summary>The same as SM_CXSIZEFRAME. This value is not supported until Windows XP.</summary>
        SM_CXFRAME = 32,
        ...
        /// <summary>The amount of border padding for captioned windows, in pixels.</summary>
        SM_CXPADDEDBORDER = 92,

        /// <summary>The width of the screen of the primary display monitor, in pixels. This is the same value obtained by calling GetDeviceCaps as follows: GetDeviceCaps( hdcPrimaryMonitor, HORZRES). This value is not supported until Windows Vista.</summary>
        SM_CXSCREEN = 0,

        /// <summary>The width of a button in a window caption or title bar, in pixels.</summary>
        SM_CXSIZE = 30,

        /// <summary>The thickness of the sizing border around the perimeter of a window that can be resized, in pixels. SM_CXSIZEFRAME is the width of the horizontal border, and SM_CYSIZEFRAME is the height of the vertical border. The same as SM_CXFRAME.</summary>
        SM_CXSIZEFRAME = 32,
        ...
        /// <summary>The width of the virtual screen, in pixels. The virtual screen is the bounding rectangle of all display monitors. The SM_XVIRTUALSCREEN metric is the coordinates of the top of the virtual screen.</summary>
        ...
        /// <summary>The same as SM_CYFIXEDFRAME.</summary>
        SM_CYDLGFRAME = 8,

        /// <summary>The height of the rectangle around the location of a first click in a double-click sequence, in pixels. The second click must occur within the rectangle defined by SM_CXDOUBLECLK and SM_CYDOUBLECLK for the system to consider the two clicks a double-click. The two clicks must also occur within a specified time. To set the height of the double-click rectangle, call SystemParametersInfo with SPI_SETDOUBLECLKHEIGHT.</summary>
        SM_CYDOUBLECLK = 37,

        /// <summary>The height of a rectangle centered on a drag point to allow for limited movement of the mouse pointer before a drag operation begins. This value is in pixels. It allows the user to click and release the mouse button easily without unintentionally starting a drag operation.</summary>
        SM_CYDRAG = 69,

        /// <summary>The height of a 3-D border, in pixels. This is the 3-D counterpart of SM_CYBORDER.</summary>
        SM_CYEDGE = 46,

        /// <summary>The thickness of the frame around the perimeter of a window that has a caption but is not sizable, in pixels. SM_CXFIXEDFRAME is the height of the horizontal border, and SM_CYFIXEDFRAME is the width of the vertical border. Same as SM_CYDLGFRAME.</summary>
        SM_CYFIXEDFRAME = 8,
        ...
        /// <summary>The same as SM_CYSIZEFRAME. This value is not supported until Windows XP.</summary>
        SM_CYFRAME = 33,
        ...
        /// <summary>The height of the screen of the primary display monitor, in pixels. This is the same values obtained by calling GetDeviceCaps as follows: GetDeviceCaps( hdcPrimaryMonitor, VERTRES).</summary>
        SM_CYSCREEN = 1,

        /// <summary>The height of a button in a window caption or title bar, in pixels.</summary>
        SM_CYSIZE = 31,

        /// <summary>The thickness of the sizing border around the perimeter of a window that can be resized, in pixels. SM_CXSIZEFRAME is the width of the horizontal border, and SM_CYSIZEFRAME is the height of the vertical border. Same as SM_CYFRAME.</summary>
        SM_CYSIZEFRAME = 33,
        ...
        /// <summary>The height of the virtual screen, in pixels. The virtual screen is the bounding rectangle of all display monitors. The SM_YVIRTUALSCREEN metric is the coordinate of the left side of the virtual screen.</summary>
        ...
        /// <summary>Nonzero if the debug version of User.exe is installed; otherwise, 0. Nonzero if the double-byte character-set (DBCS) version of User.exe is installed; otherwise, 0.</summary>
        SM_DEBUG = 22,

        /// <summary>Nonzero if Input Method Manager/Input Method Editor features are enabled; otherwise, 0. SM_IMMENABLED indicates whether the system is ready to use a Unicode-based IME on a Unicode application. To ensure that a language-dependent IME works, check SM_DBCSENABLED and the system ANSI code page. Otherwise the ANSI-to-Unicode conversion may not be performed correctly, or some components like fonts or registry settings may not be present.</summary>
        SM_IMMENABLED = 82,
        ...
        /// <summary>This system metric is used in a Terminal Services environment. Its value is nonzero if the current session is remotely controlled; otherwise, 0.</summary>
        SM_REMOTECONTROL = 0x2001,

        /// <summary>This system metric is used in a Terminal Services environment. If the calling process is associated with a Terminal Services client session, the return value is nonzero. If the calling process is associated with the Terminal Server console session, the return value is 0. The console session is not necessarily the physical console. For more information, see WTSGetActiveConsoleSessionId.</summary>
        ...
        /// <summary>Nonzero if the computer has a low-end (slow) processor; otherwise, 0. Windows 2000/NT and Windows Me/98/95: This value is not supported.</summary>
        SM_SLOWMACHINE = 73,

        /// <summary>Nonzero if the current operating system is Windows XP Starter Edition; otherwise, 0.</summary>
        SM_STARTER = 88,

        /// <summary>Nonzero if the meanings of the left and right mouse buttons are swapped; otherwise, 0.</summary>
        SM_SWAPBUTTON = 23,

        /// <summary>Nonzero if the current operating system is the Windows XP Tablet PC edition, 0 if not.</summary>
        SM_TABLETPC = 86,
