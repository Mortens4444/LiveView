namespace Mtf.Enums.Window
{
    public enum WindowMessages : int
    {
        ...
        /// <summary>The WM_DEADCHAR message is posted to the window with the keyboard focus when a WM_KEYUP message is translated by the TranslateMessage function. WM_DEADCHAR specifies a character code generated by a dead key. A dead key is a key that generates a character, such as the umlaut (double-dot), that is combined with another character to form a composite character. For example, the umlaut-O character (�) is generated by typing the dead key for the umlaut character, and then typing the O key.</summary>
        WM_DEADCHAR = 0x103,
        ...
        /// <summary>he WM_RBUTTONDBLCLK message is posted when the user double-clicks the right mouse button while the cursor is in the client area of a window. If the mouse is not captured, the message is posted to the window beneath the cursor. Otherwise, the message is posted to the window that has captured the mouse.</summary>
        ...
        /// <summary>Sunell window messages.</summary>
        WM_LIVEPLAY_MESSAGE = WM_USER + 1000,
