...
namespace CameraApp.Tests.Services
{
    ...
    public class CameraLaunchContextParserTests
    {
        ...
        {
            Assert.Throws<ArgumentNullException>(() => CameraLaunchContextParser.Parse(null));
        }
        ...
        public void ParseLength4StartCamera()
        {
            ...
            var ctx = CameraLaunchContextParser.Parse(args);
        ...
        {
            var args = new[] { "0", "1", "2" };
            Assert.Throws<NotSupportedException>(() => CameraLaunchContextParser.Parse(args));
        }
    }
}