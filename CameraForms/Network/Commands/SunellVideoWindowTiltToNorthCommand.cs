...
{
    public class SunellVideoWindowTiltToNorthCommand : ICommand
    {
        private readonly SunellVideoWindow sunellVideoWindow;
        private readonly short cameraMoveValue;

        public SunellVideoWindowTiltToNorthCommand(SunellVideoWindow sunellVideoWindow, short cameraMoveValue = 0)
        {
