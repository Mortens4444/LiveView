...
{
    public class SunellVideoWindowPanToEastCommand : ICommand
    {
        private readonly SunellVideoWindow sunellVideoWindow;
        private readonly short cameraMoveValue;

        public SunellVideoWindowPanToEastCommand(SunellVideoWindow sunellVideoWindow, short cameraMoveValue = 0)
        {
