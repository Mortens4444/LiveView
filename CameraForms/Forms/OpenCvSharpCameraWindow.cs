...
namespace CameraForms.Forms
{
    public partial class OpenCvSharpCameraWindow : Form
    {
        ...
        public OpenCvSharpCameraWindow(PermissionManager<User> permissionManager, IPersonalOptionsRepository personalOptionsRepository, string url, Rectangle rectangle, GridCamera gridCamera)
        {
            InitializeComponent();
        ...
        private void Initialize(long userId, long cameraId, Rectangle rectangle, DisplayDto display, bool fullScreen)
        {
            ...
            if (fullScreen)
            {
                ...
                client = CameraRegister.RegisterCamera(userId, cameraId, display, ClientDataArrivedEventHandler, CameraMode.OpenCvSharp);
