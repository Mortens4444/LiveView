...
namespace CameraForms.Forms
{
    public partial class OpenCvSharp4CameraWindow : Form
    {
        ...
        public OpenCvSharp4CameraWindow(PermissionManager<User> permissionManager, ICameraRepository cameraRepository,
        ...
        public OpenCvSharp4CameraWindow(CameraLaunchContext cameraLaunchContext)
        {
        ...
        private void SetupFullscreenPtz(long userId, long cameraId, DisplayDto display)
        {
            ...
            fullScreenCameraMessageHandler = new FullScreenCameraMessageHandler(userId, cameraId, this, display, CameraMode.OpenCvSharp4, cameraFunctionRepository, cameraRegister);
        ...
        private void OpenCvSharp4_Shown(object sender, EventArgs e)
        {
            ...
            else
            {
                permissionMonitor = new PermissionMonitor(
                    ...
                    {
                        permissionSetter.SetGroups(permissionManager.CurrentUser);
                        return permissionManager.HasCameraPermission(camera, openCvSharp4VideoWindow);
                    },
                    () =>
                    {
                        Initialize();
        ...
        private void Initialize()
        {
            ...
            OsdSetter.SetInfo(this, openCvSharp4VideoWindow, gridCamera, osdSettings, text);
        }
